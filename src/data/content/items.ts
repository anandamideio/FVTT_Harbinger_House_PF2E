...
export const ARTIFACT_ITEMS: HarbingerItem[] = [THE_PLANARITY, THE_FOCRUX];
...
export const ARMOR_ITEMS: HarbingerItem[] = [CLOAK_OF_FIGMENTS, BRACERS_OF_ARMOR];
