...
describe('generateRuneWeaponName', () => {
  ...
  it('adds greater striking prefix', () => {
    expect(generateRuneWeaponName('Longsword', { striking: 'greaterStriking' }))
      .toBe('Greater Striking Longsword');
  });

  it('adds major striking prefix', () => {
    expect(generateRuneWeaponName('Longsword', { striking: 'majorStriking' }))
      .toBe('Major Striking Longsword');
  });

  it('combines potency and striking', () => {
    expect(generateRuneWeaponName('Longsword', { potency: 1, striking: 'striking' }))
      .toBe('+1 Striking Longsword');
  });

  it('adds property runes', () => {
    expect(generateRuneWeaponName('Longsword', { property: ['flaming'] }))
      .toBe('Flaming Longsword');
  });

  it('converts camelCase property runes to Title Case', () => {
    expect(generateRuneWeaponName('Longsword', { property: ['greaterFlaming'] }))
      .toBe('Greater Flaming Longsword');
  });
